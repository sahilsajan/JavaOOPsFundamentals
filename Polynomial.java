...
public class Polynomial {
	int degCoeff[];
	/*this is a function that sets coefficient for a particular degree value, if degree is not there in the
	 * polynomial then corresponding term(with specified degree and value) is added in the polynomial.
	 * If the degree is already present in the polynomial then previous coefficient isreplaced by 
	...
	public void setCoefficient(int degree, int coeff) {
		if(degree > degCoeff.length-1) {
			//create a new array wit size = degree+1
			int temp[] = degCoeff;
	...
	//multiply two polynomials and returns a new polynomial with result
